...
public class Msgs {
    ...
    public static final String NEW_WEIGHT_REQUEST = PREFIX + trans(lang.getString("new-weight-request"));
    public static final String NEW_WEIGHT_SET = PREFIX + trans(lang.getString("new-weight-set"));

    public static final String WEIGHT_DISPLAY = trans(lang.getString("weight-display"));
    public static final String CHANCE_DISPLAY = trans(lang.getString("chance-display"));
    public static final String CHANGE_WEIGHT_HINT = trans(lang.getString("change-weight-hint"));
